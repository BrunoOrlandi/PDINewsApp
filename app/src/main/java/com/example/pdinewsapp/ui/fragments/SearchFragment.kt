...
import com.example.pdinewsapp.activity.OcrCaptureActivity
import com.example.pdinewsapp.adapters.NewsAdapter
import com.example.pdinewsapp.databinding.FragmentSearchBinding
import com.example.pdinewsapp.ui.MainActivity
import com.example.pdinewsapp.ui.NewsViewModel
import com.example.pdinewsapp.util.Constants
import com.example.pdinewsapp.util.Constants.Companion.SEARCH_NEWS_TIME_DELAY
import com.example.pdinewsapp.util.Resource
...
class SearchFragment : Fragment(R.layout.fragment_search) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.ocrButton.setOnClickListener {
            val intent = Intent(requireContext(), OcrCaptureActivity::class.java)
    ...
    val scrollListener = object : RecyclerView.OnScrollListener(){
        ...
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            val shouldPaginate = isNoErrors && isNotLoadingAndNotLastPage && isAtLastItem
                    && isNotAtBeggining && isTotalMoreThanVisible && isScrolling
            if (shouldPaginate) {
                newsViewModel.searchNews(binding.searchEdit.text.toString())
                isScrolling = false
            }
    ...
    private val ocrLauncher = registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
        if (result.resultCode == Activity.RESULT_OK) {
            ...
            binding.searchEdit.setText(recognizedText)
        }
    }
}